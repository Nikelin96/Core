namespace Base.StateMachine.Models.V1.States
{
    ...
    public class StateDisabled : BaseState<DataStructureV1, IStateContainer<DataStructureV1>>
    {
        public StateDisabled(IStateContainer<DataStructureV1> stateContainer, DataStructureV1 data)
            : base(stateContainer, StateEnumV1.Disabled, data)
        {
            Thread.Sleep(2000);    
        }
